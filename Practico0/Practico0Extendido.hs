...
testInter3 :: (M, V)
testInter3 =
  eval ([], Inter (Union (Unit 1) (Unit 2)) (Union (Unit 2) (Unit 3)))
...
testIncl6 =
  eval
    ( []
    , Incl (Union (Unit 1) (Unit 2)) (Union (Unit 1) (Union (Unit 2) (Unit 3))))

-- Tests de Equal
testEqual1 :: (M, V)
testEqual1 =
  eval ([], Equal (Union (Unit 1) (Unit 2)) (Union (Unit 2) (Unit 1)))

testEqual2 :: (M, V)
testEqual2 =
  eval ([], Equal (Union (Unit 1) (Unit 2)) (Union (Unit 1) (Unit 3)))
...
testEqual7 =
  eval
    ( []
    , Equal (Union (Unit 1) (Unit 2)) (Union (Unit 1) (Union (Unit 2) (Unit 3))))
...
main = do
  ...
  putStrLn
    $ "Potencia de una potencia de {1, 2}: " ++ prettyPrintResult testPot5
  putStrLn "\nTests de Pert:"
  ...
  putStrLn
    $ "{1, 2} esta incluido en {1, 2, 3}? " ++ prettyPrintResult testIncl6
  putStrLn "\nTests de Equal:"
